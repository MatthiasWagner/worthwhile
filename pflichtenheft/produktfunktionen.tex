...
Die GUI stellt einen Editor f\"{u}r die spezifizierte While-Sprache zur Verf\"{u}gung. Folgende Funktionen unterst\"{u}tzen den Benutzer bei der Eingabe des Programmcodes:
...
Der Interpreter kann ein Programm in einem von zwei verschiedenen Modi ausf"{u}hren:
